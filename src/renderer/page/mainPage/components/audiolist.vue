							...
							<div class=" flex flex-align-center">
								...
								<div class="flex-1 ml20 flex flex-pack-justify">
									<div>
										...
										<div
											class="mt10"
											:style="{ color: item.maxScore >= 90 ? '#4fb57e' : item.maxScore >= 80 ? '#1890ff' : item.maxScore >= 60 ? '#fad111' : '#ec6d64' }"
										>
											({{ item.maxScore | fliterScore }})
										</div>
									</div>
...
.rightbar {
	...
	& > .flex {
		box-shadow: 0 0 10px rgba(67, 132, 212, 0.4);
		width: 270px;
		border-radius: 6px;
		height: 100%;
		opacity: 0;

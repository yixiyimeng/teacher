<template>
	<div class="bottommenu">
		...
		<a href="javascript:;" class="prev" :class="{'special':subjecttitle==9&&isAnswering}" @click="prevQuestion" v-show="(isSubject && !isAddSubject)||(subjecttitle==9&&isAnswering)">
			<i></i>
		</a>
		<a href="javascript:;" class="next" :class="{'special':subjecttitle==9&&isAnswering}" @click="nextQuestion" v-show="(isSubject && !isAddSubject)||(subjecttitle==9&&isAnswering)">
			<i></i>
		</a>
		<!-- 点名 -->

		...
		& > a {
			...
			&.countDown {
				i {
					...
					box-shadow: 3px 3px 10px rgba(119, 177, 154, 0.5);
				}
			}
			...
			&.rollCall {
				i {
					...
					box-shadow: 3px 3px 10px rgba(24, 144, 255, 0.5);
				}
			}
			...
			&.pickName {
				i {
					...
					box-shadow: 3px 3px 10px rgba(241, 193, 107, 0.5);
				}
			}
			...
			&.barrage {
				i {
					...
					box-shadow: 3px 3px 10px rgba(123, 109, 251, 0.5);
				}
			}
			...
			&.more {
				i {
					...
					box-shadow: 3px 3px 10px rgba(87, 119, 166, 0.5);
				}
			}

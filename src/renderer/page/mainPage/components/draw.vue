<template>
	<div ref="drawbox" style="position: fixed; border: 1px solid #f00; z-index: 1; top: 0; left: 0; bottom: 0; right: 0;">
		<canvas id="draw" ref="draw" 
		 width="1000" height="500">您的浏览器不支持画布！</canvas>	
	</div>
</template>

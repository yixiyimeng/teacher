<template>
	<div style="height: 100%; width: 100%;">
		<div class="tip" v-if="subjecttitle == 3">
			...
			<a class="text-blue" href="javascript:;" v-if="selectAnswerStr" @click="handAnswerStr">查看选择{{ selectAnswerStr }}人员名单</a>
		</div>
		<div id="barChart"></div>
	</div>
</template>
